crystal_ver_up? = Crystal::VERSION
  .split(".")
  .map(&.to_i)
  .zip([0, 18, 7])
  .map { |current_ver, monkey_ver| current_ver > monkey_ver }
  .reduce { |ver_up?, b| ver_up? || b }
raise Exception.new("Check this monkey patch is valid yet in this Crystal ver.") if crystal_ver_up?

# https://github.com/crystal-lang/crystal/blob/161452a5c4d8ace76efca9fb5dea38294d4a971c/src/io/console.cr
